    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <nav className="flex justify-between items-center px-10 py-6 sticky top-0 bg-white/80 backdrop-blur-md z-50 border-b border-slate-50">
        <div className="flex items-center gap-2 font-black text-2xl tracking-tighter">
          <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white text-xs italic">
            M
          </div>
          <span>
            MEDIC<span className="text-blue-600">OS</span>
          </span>
        </div>
        ...
        <button
          ...
          className="bg-slate-900 text-white px-6 py-3 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 transition-all shadow-xl shadow-blue-100"
        >
          Staff Portal
        </button>
      </nav>
      ...
      <section className="px-10 py-20 lg:py-32 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-7xl mx-auto">
        <div className="space-y-8 animate-in slide-in-from-left duration-700">
          ...
          <p className="text-slate-500 text-lg font-medium leading-relaxed max-w-md">
            Dedicated to providing specialized medical treatment and
            personalized health management services in Sri Lanka.
          </p>
          <div className="flex gap-4">
            <button
              onClick={() => navigate("/book-appointment")}
              className="bg-blue-600 text-white px-8 py-5 rounded-3xl font-black text-xs uppercase tracking-widest shadow-2xl shadow-blue-500/20 hover:scale-105 transition-all flex items-center gap-3"
            >
              Book Appointment <ArrowRight size={16} />
            </button>
            <button
              onClick={() => navigate("/specialists")}
              className="bg-white border border-slate-200 px-8 py-5 rounded-3xl font-black text-xs uppercase tracking-widest hover:bg-slate-50 transition-all"
            >
              Our Specialists
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                title: "Cardiology",
                desc: "Expert heart care and vascular diagnostics.",
                icon: <Heart className="text-rose-500" />,
              },
              {
                title: "General OPD",
                desc: "Routine health checkups and basic treatments.",
                icon: <Activity className="text-blue-500" />,
              },
              {
                title: "Laboratory",
                desc: "Advanced blood tests and diagnostic reports.",
                icon: <Shield className="text-emerald-500" />,
              },
            ].map((service, i) => (
              <div
                key={i}
                className="bg-white p-10 rounded-[3rem] border border-slate-100 hover:shadow-xl transition-all group"
              >
      ...
      <footer className="px-10 py-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="space-y-4">
          ...
          <p className="text-slate-400 text-xs font-medium leading-relaxed">
            Providing the best clinical care for patients in Colombo and
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <p className="flex items-center gap-2 text-xs font-bold text-slate-500">
              <Phone size={14} /> 011 234 5678
            </p>
            <p className="flex items-center gap-2 text-xs font-bold text-slate-500">
              <MapPin size={14} /> 123, Medical Rd, Colombo
            </p>
          </div>
        </div>
        <div className="space-y-4">
          ...
          <p className="flex items-center gap-2 text-xs font-bold text-slate-500">
            <Clock size={14} /> 24/7 Emergency Care
          </p>
