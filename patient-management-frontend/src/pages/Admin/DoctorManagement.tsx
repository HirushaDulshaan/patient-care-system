...
const DoctorManagement = () => {
  ...
  const [registerDoctor, { loading: regLoading }] = useMutation(
    REGISTER_DOCTOR,
    {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (selectedDoctor) {
        ...
        await updateDoctor({
          variables: { id: selectedDoctor.id, ...updateData },
        });
        toast.success("Specialist details have been updated successfully.");
      } else {
        await registerDoctor({ variables: { ...formData } });
        toast.success("New specialist has been added to the registry.");
      }
      resetForm();
    } catch (err: any) {
      toast.error("An error occurred while saving the specialist details.");
    }
  };
          ...
          <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-sm">
            <div className="mb-8">
              ...
              <p className="text-slate-400 text-xs font-medium uppercase tracking-widest mt-1">
                {selectedDoctor
                  ? `Modifying Dr. ${selectedDoctor.lastName}`
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    type="text"
                    className="w-full p-3 bg-slate-50 border border-slate-100 rounded-xl outline-none text-sm focus:border-blue-500 transition-all"
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className={`w-full p-3 bg-slate-50 border border-slate-100 rounded-xl outline-none text-sm focus:border-blue-500 transition-all ${selectedDoctor && "opacity-50"}`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      type="text"
                      className="w-full p-3 bg-slate-900/5 border border-slate-200 rounded-xl outline-none text-sm font-semibold"
                  ...
                  <div className="md:col-span-2 space-y-1">
                    ...
                    <input
                      ...
                      type="text"
                      className="w-full p-3 bg-slate-900/5 border border-slate-200 rounded-xl outline-none text-sm font-semibold"
                      placeholder="Enter Primary Hospital"
                    />
                  </div>
                </div>
              </div>
                          ...
                          <div className="flex flex-col gap-1 mt-3">
                            <div className="flex items-center gap-2 text-slate-400">
                              ...
                              <span className="text-[10px] font-medium">
                                {doc.workingHospital || "Private Practice"}
                              </span>
                            </div>
                            <div className="flex items-center gap-2 text-slate-400">
                              <MapPin size={11} />
                              <span className="text-[10px] font-medium">
                                {doc.city || "Location N/A"}
                              </span>
                            </div>
                            <div className="flex items-center gap-2 text-slate-400">
