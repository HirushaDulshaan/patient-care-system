...
import { Search, Calendar, Users, UserCheck, Loader2 } from "lucide-react";
...
const DoctorPatientInsights = () => {
  ...
  const { data, loading } = useQuery(GET_ALL_DOCTOR_INSIGHTS, {
      ...
      <div className="flex justify-between items-end mb-4">
        <div>
          ...
          <p className="text-slate-400 font-bold text-xs uppercase tracking-widest">
            Global Physician & Patient Flow Tracking
          </p>
        </div>
        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm">
            ...
            {loading ? (
              ...
              <div className="py-10 text-center text-slate-300 font-bold text-sm italic">
                No physicians found for this date.
              </div>
            ) : (
          ...
          {selectedDoc ? (
                  ...
                  <tbody className="divide-y divide-slate-50">
                    {patientHistory.length > 0 ? (
                      patientHistory.map((app: any, i: number) => (
                        ...
                        >
                          <td className="p-6 text-xs font-black text-slate-300 text-center">
                            {i + 1}
                          </td>
                          <td className="p-6">
                          ...
                          <td className="p-6">
                            <span className="text-[11px] font-bold text-blue-700 bg-blue-50 px-3 py-1 rounded-lg">
                              {app.medicalRecords?.[0]?.diagnosis ||
                                "Ongoing/Incomplete"}
                            </span>
                          </td>
                      ...
                      <tr>
                        ...
                        >
                          No completed visits found for this physician on this
                          date.
                        </td>
                      </tr>
                    )}
            ...
            <div className="h-full flex flex-col items-center justify-center bg-white border-2 border-dashed border-slate-200 rounded-[3.5rem] p-20 text-slate-300">
              ...
              <p className="text-xl font-black uppercase tracking-widest text-slate-400">
                Physician Insight Portal
              </p>
              <p className="text-sm font-medium italic mt-2 text-slate-300 text-center max-w-xs">
                Select a doctor from the list to view their patient flow and
                clinical records.
              </p>
            </div>
          )}
