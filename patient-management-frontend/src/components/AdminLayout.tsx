...
import { ChevronDown, ChevronRight, Users, UserPlus, Calendar, PieChart, LogOut } from 'lucide-react';

const AdminLayout = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [isStaffOpen, setIsStaffOpen] = useState(true); // Manage Staff sub-menu toggle

  // Active link check karanna function ekak
        ...
        <nav className="space-y-2">
          ...
          <div className="space-y-1">
            ...
            >
              ...
              {isStaffOpen ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
            </button>
